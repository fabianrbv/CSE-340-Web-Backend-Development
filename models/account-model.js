...
/* *****************************
 * Return account data using email address (public version, no password)
 * ***************************** */
async function getAccountByEmailPublic (account_email) {
  try {
    const result = await pool.query(
...
module.exports = { checkExistingEmail, registerAccount, getAccountByEmail, getAccountByEmailPublic, getAccountById, updateAccountInfo, updateAccountPassword }